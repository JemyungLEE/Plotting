...
with open('/Users/leejmacbook/github/microData/India/data/emission/2011_IND_hhs_emission_incByRel_perCap.csv') as csvfile:
...
fig.update_layout(
    ...
    yaxis=dict(anchor='y1', title="<br>Household consumption CF per capita (tCO<sub>2</sub>/yr/capita)", range=[0, 1.6],
               ticks="outside", showline=True,
               linewidth=2, linecolor='black', mirror=False, tickvals=[0.3, 0.6, 0.9, 1.2, 1.5], tickformat=".1f",
               titlefont=dict(family='/Library/Fonts/SF Pro Display', size=20, color='black'),
               ),
    yaxis2=dict(anchor='y2', range=[0, 1.6], showline=False, showticklabels=False),
    yaxis3=dict(anchor='y3', range=[0, 1.6], showline=False, showticklabels=False),
    yaxis4=dict(anchor='y4', range=[0, 1.6], showline=False, showticklabels=False),
    yaxis5=dict(anchor='y5', range=[0, 1.6], showline=False, showticklabels=False),
    yaxis6=dict(anchor='y6', range=[0, 1.6], showline=False, showticklabels=False),
    yaxis7=dict(anchor='y7', range=[0, 1.6], showline=False, showticklabels=False),
    yaxis8=dict(anchor='y8', range=[0, 1.6], showline=False, showticklabels=False),
    yaxis9=dict(anchor='y9', range=[0, 1.6], showline=False, showticklabels=False),
    yaxis10=dict(anchor='y10', range=[0, 1.6], showline=False, showticklabels=False),
    yaxis11=dict(anchor='x11', range=[0, 1.6], showline=True, showticklabels=False,
                 linewidth=2, linecolor='black', tickvals=[0.3, 0.6, 0.9, 1.2, 1.5], ticks="outside", side="right"),
    ...
    annotations=[
        ...
        dict(
            ...
            showarrow=False,
            font=dict(family='/Library/Fonts/SF Pro Display', size=18, color='black'),
        ) for xpos, ypos in zip([0, 1, 2, 3, 4],[0.262, 0.275, 0.28, 0.33, 0.375])
    ]+[
        dict(
            x=2,y=-0.075,
            xref='x'+str((i+1)*2),
...
# fig.update_yaxes(title="<br>Household consumption CF per capita (tCO<sub>2</sub>/yr/capita)",range=[0,1.6],ticks="outside", showline=True,
#                  linewidth=2, linecolor='black', mirror="allticks",tickvals=[0.3,0.6,0.9,1.2,1.5],tickformat=".1f",
#                  titlefont=dict(family='/Library/Fonts/SF Pro Display', size=20, color='black'))
fig.show()