...
with open('/Users/leejmacbook/github/microData/India/data/emission/2011_IND_hhs_Food_emission_incByRel_perCap_exp.csv') as csvfile:
...
#     for i in range(nrel):
#         writer.writerow("")
#         writer.writerow(religions[i])
#         writer.writerow(categories)
#         for j in range(nexp):
#             writer.writerow(yvals[i,j,:])
...
fig.update_layout(
    ...
    # yaxis=dict(anchor='y1', title="<br>Household food-consumption CF per capita (tCO<sub>2</sub>/yr/capita)", range=[0, 0.25],
    yaxis=dict(anchor='y1', title="<br>Household food expenditure per capita (Thousands INR/yr/capita)", range=[0, 20],
               ticks="outside", showline=True,
               # linewidth=2, linecolor='black', mirror=False, tickvals=[0, 0.05, 0.1, 0.15, 0.2, 0.25], tickformat=".2f",
               linewidth=2, linecolor='black', mirror=False, tickvals=[0, 5, 10, 15, 20],
               titlefont=dict(family='/Library/Fonts/SF Pro Display', size=20, color='black'),
               ),
    # yaxis2=dict(anchor='y2', range=[0, 0.25], showline=False, showticklabels=False),
    # yaxis3=dict(anchor='y3', range=[0, 0.25], showline=False, showticklabels=False),
    # yaxis4=dict(anchor='y4', range=[0, 0.25], showline=False, showticklabels=False),
    # yaxis5=dict(anchor='y5', range=[0, 0.25], showline=False, showticklabels=False),
    # yaxis6=dict(anchor='y6', range=[0, 0.25], showline=False, showticklabels=False),
    # yaxis7=dict(anchor='y7', range=[0, 0.25], showline=False, showticklabels=False),
    # yaxis8=dict(anchor='y8', range=[0, 0.25], showline=False, showticklabels=False),
    # yaxis9=dict(anchor='y9', range=[0, 0.25], showline=False, showticklabels=False),
    # yaxis10=dict(anchor='y10', range=[0, 0.25], showline=False, showticklabels=False),
    # yaxis11=dict(anchor='x11', range=[0, 0.25], showline=True, showticklabels=False,
    #               linewidth=2, linecolor='black', tickvals=[0, 0.05, 0.1, 0.15, 0.2, 0.25], ticks="outside", side="right"),
    yaxis2=dict(anchor='y2', range=[0, 20], showline=False, showticklabels=False),
    yaxis3=dict(anchor='y3', range=[0, 20], showline=False, showticklabels=False),
    yaxis4=dict(anchor='y4', range=[0, 20], showline=False, showticklabels=False),
    yaxis5=dict(anchor='y5', range=[0, 20], showline=False, showticklabels=False),
    yaxis6=dict(anchor='y6', range=[0, 20], showline=False, showticklabels=False),
    yaxis7=dict(anchor='y7', range=[0, 20], showline=False, showticklabels=False),
    yaxis8=dict(anchor='y8', range=[0, 20], showline=False, showticklabels=False),
    yaxis9=dict(anchor='y9', range=[0, 20], showline=False, showticklabels=False),
    yaxis10=dict(anchor='y10', range=[0, 20], showline=False, showticklabels=False),
    yaxis11=dict(anchor='x11', range=[0, 20], showline=True, showticklabels=False,
                 linewidth=2, linecolor='black', tickvals=[0, 5, 10, 15, 20], ticks="outside", side="right"),
    ...
    annotations=[
        ...
        dict(
            ...
            showarrow=False,
            font=dict(family='/Library/Fonts/SF Pro Display', size=18, color='black'),
        # ) for xpos, ypos in zip([0, 1, 2, 3, 4],[0.077, 0.0765,0.0825,0.068,0.0775])
        ) for xpos, ypos in zip([0, 1, 2, 3, 4],[5.95, 6.35, 6.38, 6.1, 6.2])
    ]+[
        dict(
            x=2,y=-0.075,
            xref='x'+str((i+1)*2),
