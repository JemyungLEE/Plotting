...
xvalsSecond = np.append(xvalsSecond, [xvalsFirst[0], xvalsFirst[0]])
yvalsSecond = np.append(yvalsSecond, [yvalsSecond[-1], yvalsSecond[0]])
xvalsThird = np.append(xvalsThird, [xvalsFirst[0], xvalsFirst[0]])
...
fig.update_layout(
    ...
    annotations=[
                dict(
                    x=0.35, y=0.096, xref='x', yref='y', showarrow=False,
                    text='<b>Scenario 1:</b> 13.3Mt/CO<sub>2</sub>/yr (1.97%▲)', textangle=0, align='left',
                    font=dict(family='/Library/Fonts/SF Pro Display', size=18, color='black'),
                )
            ] + [
                dict(
                        x=0.8, y=0.28, xref='x', yref='y', showarrow=False,
                        text='<b>Scenario 2:</b> 82.3Mt/CO<sub>2</sub>/yr (12.19%▲)', textangle=0, align='left',
                        font=dict(family='/Library/Fonts/SF Pro Display', size=18, color='black'),
                )
            ] + [
                dict(
                    x=0.75, y=0.95, xref='x', yref='y', showarrow=False,
                    text='<b>Scenario 3</b><br>333.1Mt/CO<sub>2</sub>/yr (49.36%▲)', textangle=0, align='right',
                    font=dict(family='/Library/Fonts/SF Pro Display', size=18, color='black'),
                )
            ] + [
                dict(
